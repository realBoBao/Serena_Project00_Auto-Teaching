...
// Deterministic UUIDv5-like ID from string — Qdrant requires UUID or unsigned integer
function toQdrantId(input) {
  // Use SHA-256 hash → take first 16 bytes → format as UUID
